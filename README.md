...
![]((https://github.com/chrisnweb/Bitcoin-Price-Predictions/blob/master/Images/confusionmatrix.PNG) width=100)
...
* Data scaling
  ...
  - We use the MinMaxScaler from [scikit learn](https://scikit-learn.org/stable/index.html)
